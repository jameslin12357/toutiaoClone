...
//   connection.query(`insert into videos (title, description, src, userid) values ('${randomTitle}','${randomDescription}','http://www.mazwai.com/#/grid/videos/148', '${randomUserId}')`, function (error, results, fields) {
//     if (error) throw error;
//     console.log('The solution is: ', results);
//   });
// }
